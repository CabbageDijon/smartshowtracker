...
const client = new Client()
    .setEndpoint('http://appwrite-k3x9372ieiau8kyag0zom3bi.102.208.217.93.sslip.io/v1') // e.g., https://appwrite.yourdomain.com/v1
...
// js/appwrite.js (Append to bottom)

// Update these with your actual Appwrite IDs!
const DATABASE_ID = 'ShowTraxerDB'; // Or whatever ID Appwrite generated
const COLLECTION_ID = 'TrackedShows'; // Or whatever ID Appwrite generated
